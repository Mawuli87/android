...
//                        RTLToast.Config.reset();
    ...
    public void EndTimeMessage(View view) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SubscriptionActivity.this);
        builder.setMessage("Pastor can say something about the end time. See what we are living now.Let the pastor decide what to add as content in evey section.")
